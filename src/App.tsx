          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-900 p-8 rounded-3xl text-white">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                 ...
                 <CheckItem label="Bônus Fixo R$ 300" status={bonusFixo} desc="Garantir Indicadores" />
               </div>
            </div>
             ...
             <div className="bg-white rounded-3xl border shadow-xl p-6 overflow-x-auto">
               <table className="w-full text-left">
                 <thead className="bg-slate-50 text-[10px] font-black uppercase text-slate-400 border-b">
                   <tr><th className="p-4">Semana</th><th className="p-4">Faturamento (R$)</th><th className="p-4">Ticket Médio (R$)</th></tr>
                 </thead>
                 <tbody className="divide-y font-bold">
                   {[1,2,3,4].map(w => (
                     <tr key={w}>
